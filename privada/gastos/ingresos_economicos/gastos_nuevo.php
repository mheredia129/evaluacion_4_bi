...
$sql = $db->Prepare("SELECT *
	                   FROM domicilios d , efectivo_disponible ed, ingresos_economicos ie
	                   WHERE ed.efectivo_disponible_pk = ie.ingreso_economico_pk
...
$smarty->display("ingreso_economico_nuevo.tpl");
?>
